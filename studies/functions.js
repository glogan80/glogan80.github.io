/**
 * FUNCTIONS - Fundamental building block in JavaScript, a set of statements that performs a task or calculates a value.
 * 
 ...
 **/
 ...
 /**
 * SYNTAX FOR NAMED FUNCTION - you want to call "function" and then assign it a name, "saints", and then hold a parameter or argument
 * inside the parenthese 
 **/ 
 
    function saints (superbowls) { 
        return 1; 
    }
    
    console.log(saints()); //prints 1 to the console
 ...
 **/
    ...
    let saintsSuperbowls = function(){
        return 1;
    };
    
    console.log(saintsSuperbowls()); // prints 1 to the console
 ...
 **/
 ...
 /** 
 * CLOSURES - Typically thought of as functions inside of functions. While this is true, there's more to it.
